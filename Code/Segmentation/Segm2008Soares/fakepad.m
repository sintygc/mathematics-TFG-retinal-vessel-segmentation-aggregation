...
mask = imerode(mask, strel('disk', erosionsize, 0)); %la zona blanca se hace más pequeña
%img=bigimg es la imagen original, con fondo blanco y ojo en escala de grises, más borde en negro
dilated = img .* double(mask); %en la zona blanca de mask metemos la imagen del ojo
